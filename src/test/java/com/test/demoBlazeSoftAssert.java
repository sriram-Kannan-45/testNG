...
public class demoBlazeSoftAssert {
	...
	@Test 
	  public void loginCheck() throws InterruptedException 
	  {
		  ...
		  soft.assertEquals(actual, expect,"No Welcome Admin come");
...
//		  soft.assertAll();
	  ...
	  public void loginCheckInValPass() 
	  {
		  ...
		  String expect = "Wrong passwor";

		  soft.assertEquals(actual, expect,"No Wrong work ");
